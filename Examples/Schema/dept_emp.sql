...
INSERT INTO emp VALUES (7788, 'SCOTT' , 'ANALYST'  , 7566, STR_TO_DATE('13-6-2017' , '%d-%m-%Y'), 3000, NULL, 20);
...
INSERT INTO emp VALUES (7654, 'MARTIN', 'SALESMAN' , 7698, STR_TO_DATE('28-9-2011' , '%d-%m-%Y'), 1250, 1400, 30);
INSERT INTO emp VALUES (7844, 'TURNER', 'SALESMAN' , 7698, STR_TO_DATE('8-9-2011'  , '%d-%m-%Y'), 1500,    0, 30);
INSERT INTO emp VALUES (7876, 'ADAMS' , 'CLERK'    , 7788, STR_TO_DATE('13-6-2017' , '%d-%m-%Y'), 1100, NULL, 20);
